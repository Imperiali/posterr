...
jest.mock("../../components/shared/PostsProvider", () => jest.fn(({ children }) => children))
jest.mock("../../components/shared/UsersProvider", () => jest.fn(({ children }) => children))
jest.mock("../../components/shared/UserProvider", () => jest.fn(({ children }) => children))
